...
function measSourceActivity(step, time, dt)
  curSol = measSourceObserver:get_current_solution()
	local measConc = take_measurement(curSol, time, "meas2", "ca_cyt", outDir.."meas/ttttttt")
  return measConc
end
...
function measWaveActivity(step, time, dt)
	...
	local measConc = take_measurement(curSol, time, "meas2r", "ca_cyt", outDir.."meas/ttttttt")
  return measConc
end
